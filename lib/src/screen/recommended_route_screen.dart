...
class RecommendedRouteScreen extends StatefulWidget {
  const RecommendedRouteScreen({super.key});

  @override
  State<StatefulWidget> createState() => RecommendedRouteScreenState();
}

class RecommendedRouteScreenState extends State<StatefulWidget> {
